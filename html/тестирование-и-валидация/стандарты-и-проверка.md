---
aliases: [articles-sections, Семантические элементы article и section]
tags: [programming, html, semantics, web-development, accessibility, frontend, structure, best-practices]
---
...
Элемент `<article>` представляет собой независимый, автономный фрагмент содержимого, который может быть распространен, переиздан или использован независимо от остального сайта.
...
<main>
    <article>
        <header>
            ...
            <p>Автор: <a href="/author">Иван Петров</a></p>
...
3. **Поддержка** - упрощает сопровождение и отладку кода
4. **Профессионализм** - повышает качество веб-разработки
...
<article itemscope itemtype="http://schema.org/Article">
    <header>
        ...
        <p>Опубликовано:
            <time datetime="2023-03-15" itemprop="datePublished">15 марта 2023</time>
        </p>
    </header>
...
<main>
    ...
    <article class="featured-article" itemscope itemtype="http://schema.org/NewsArticle">
        <header>
            ...
            <p>Опубликовано:
                <time datetime="2023-03-15T08:00:00+00:00" itemprop="datePublished">15 марта 2023, 11:00</time>
            </p>
    ...
    <section aria-labelledby="comments-section">
        ...
        <article class="comment" itemscope itemtype="http://schema.org/Comment">
            <header>
                ...
                <p>Опубликовано:
                    <time datetime="2023-03-15T10:30:00+00:00" itemprop="dateCreated">13:30</time>
                </p>
            </header>
            <div itemprop="text">
        ...
        <article class="comment" itemscope itemtype="http://schema.org/Comment">
            <header>
                ...
                <p>Опубликовано:
                    <time datetime="2023-03-15T11:15:00+00:00" itemprop="dateCreated">14:15</time>
                </p>
            </header>
            <div itemprop="text">
    ...
    <article itemscope itemtype="http://schema.org/TechArticle">
        <header>
            ...
            <p>Последнее обновление:
                <time datetime="2023-03-15" itemprop="dateModified">15 марта 2023</time>
            </p>
        </header>
...
<main>
    <article aria-label="Основная статья о веб-разработке">
        ...
        <footer aria-label="Информация об авторе">
            <p>Автор: Иван Иванов</p>
            <p>Опубликовано: 15 марта 2023</p>
        </footer>
    </article>
</main>
```
        ...
        <header>
            <div class="post-author">
                ...
                <div>
                    ...
                    <p>Опубликовано:
                        <time datetime="2023-03-15T15:30:00+00:00" itemprop="datePublished">30 минут назад</time>
                    </p>
                </div>
            </div>
        </header>
        ...
        <section class="post-content" itemprop="articleBody">
            ...
            <article class="comment" itemscope itemtype="http://schema.org/Comment">
                <header>
                    ...
                    <time datetime="2023-03-15T15:35:00+00:00" itemprop="dateCreated">5 минут назад</time>
                </header>
...
<main>
    <article itemscope itemtype="http://schema.org/Book">
        ...
        <footer>
            ...
            <p>Дата публикации: <time datetime="2023-03-15" itemprop="datePublished">15 марта 2023</time></p>
        </footer>
    </article>
</main>
```
...
<article itemscope itemtype="http://schema.org/BlogPosting">
    <header>
        ...
        <p>Опубликовано:
            <time datetime="2023-03-15T10:00:00+00:00" itemprop="datePublished">15 марта 2023</time>
        </p>
    </header>
...
<head>
    ...
    <link rel="canonical" href="https://example.com/semantic-elements">
</head>
<body>
    <header role="banner">
    ...
    <main role="main">
        <article itemscope itemtype="http://schema.org/Article">
            ...
            <section itemprop="articleBody">
                ...
                автономный фрагмент содержимого, который может быть распространен,
...
&lt;/article&gt;</code></pre>
            ...
            <footer>
                ...
                <p>Последнее обновление:
                    <time datetime="2023-03-15T14:30:00+00:00" itemprop="dateModified">15 марта 2023, 17:30</time>
                </p>
            </footer>
        </article>
    ...
    <script type="application/ld+json">
    {
        ...
        "@type": "Article",
        "headline": "Понимание элементов article и section в HTML5",
        "author": {
            "@type": "Person",
            "name": "Иван Иванов"
        },
        ...
        "description": "Руководство по использованию семантических элементов article и section в HTML5",
...
## Следующие темы
- [[html/семантика/заголовки-и-структура]]
- [[html/доступность]]
