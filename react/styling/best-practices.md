...
- [[react/components]] - основы компонентного подхода
- [[react/props]] - передача свойств для стилизации
- [[react/context]] - использование контекста для темизации
- [[react/hooks]] - использование хуков для управления стилями
