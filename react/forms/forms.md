...
- [[Типизация хуков React в TypeScript]] - для работы с хуками, используемых в формах
- [[Типизация компонентов React в TypeScript]] - для понимания архитектуры компонентов
