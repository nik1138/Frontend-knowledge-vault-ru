...
- Часто изменяющихся данных (лучше использовать [[react/state-management]] или [[Типизация хуков React в TypeScript]])
...
- [[Типизация хуков React в TypeScript]] - для понимания работы хуков
- [[react/state-management]] - альтернативы контексту
- [[Типизация компонентов React в TypeScript]] - для понимания передачи данных
