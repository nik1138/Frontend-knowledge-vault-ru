...
- [[Типизация хуков React в TypeScript]] - использование хуков для управления локализацией
- [[Типизация контекста в React с TypeScript]] - передача локали через контекст
