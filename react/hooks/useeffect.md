...
- [[Типизация компонентов React в TypeScript]] - для контекста использования эффектов
- [[Типизация контекста в React с TypeScript]] - для передачи данных между компонентами
