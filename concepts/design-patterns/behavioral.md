...
> Поведенческие паттерны часто используются в сочетании с [[structural]] и [[Порождающие паттерны проектирования]] паттернами для создания полной архитектуры приложения.
